...
canvas = createCanvas(displayWidth-20, displayHeight-150)
  ...
  b = createSprite(500,displayHeight/2 -100 )
  b.addImage(bg5)
  b.scale = 2
  ...
  Background = createSprite(500,displayHeight/2,100,100 )
  ...
  Background.scale = 2
   ...
   ground2 = createSprite(displayWidth,displayHeight-20,displayWidth*150)
    ...
    button = createSprite(displayWidth-220,50,20,20)
    button.addImage(bu)
    button.scale = 0.4
    ...
    PlayButton = createSprite(1150,400,10,10)
...
function draw(){
  ...
  if(gameState==="Level1"){
   ...
   // doc.visible=false;
    ...
    fill("black")
    textAlign(CENTER)
    text("VACCINE",displayWidth/2,70)
    textSize(45)
    text("SCORE:"+scoreLvl2,displayWidth-220,70)
